...
(() => {
  ...
  class ImageSlot extends HTMLElement {
    static get observedAttributes() {
      return ['shape', 'radius', 'mask', 'fit', 'position', 'placeholder', 'src', 'data-src', 'id'];
    }
    ...
    constructor() {
      ...
      root.innerHTML =
        ...
        '  <img part="image" alt="" draggable="false" referrerpolicy="no-referrer" style="display:none">' +
        ...
        '</div>' +
        '<div class="spill">' +
        '  <img class="ghost" alt="" draggable="false" referrerpolicy="no-referrer">' +
      ...
      // If an author-supplied src fails to load (e.g. a hotlink-protected or
      // throttled remote URL), fall back to the clean empty placeholder rather
      // than showing a broken-image icon. A user drop still overrides this.
      this._img.addEventListener('error', () => {
        if (this._userUrl) return;
